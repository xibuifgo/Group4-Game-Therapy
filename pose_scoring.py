...
class PoseScorer:
    def __init__(self):
        self.poses = [
            ...
            {
                "AcX": {"expected": 0.5, "tolerance": 0.3},
            ...
            # Pose 2 - Arms up (example)
            {
                "AcX": {"expected": 0.0, "tolerance": 0.3},
                "AcY": {"expected": 0.9, "tolerance": 0.3},
                "AcZ": {"expected": 0.1, "tolerance": 0.3},
                "GyX": {"expected": 0.0, "tolerance": 0.2},
                "GyY": {"expected": 0.0, "tolerance": 0.2},
                "GyZ": {"expected": 0.0, "tolerance": 0.2}
            },
            # Pose 3 - Arm to the side (example)
            {
                "AcX": {"expected": 0.8, "tolerance": 0.3},
            ...
            # Pose 5 - Arm rotating (example)
            {
                "AcX": {"expected": 0.3, "tolerance": 0.3},
                "AcY": {"expected": 0.3, "tolerance": 0.3},
                "AcZ": {"expected": 0.3, "tolerance": 0.3},
                "GyX": {"expected": 0.5, "tolerance": 0.3},
                "GyY": {"expected": 0.5, "tolerance": 0.3},
                "GyZ": {"expected": 0.5, "tolerance": 0.3}
            }
        ]
    ...
    def smooth_readings(self, new_reading):
        """Apply smoothing to sensor readings to reduce noise"""
    ...
    def calculate_score(self, pose_index):
        """Calculate how well the current position matches the expected pose"""
